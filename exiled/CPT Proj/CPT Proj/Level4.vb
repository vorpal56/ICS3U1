Public Class frmLevel4
    ...
    Dim bordersred(10) As PictureBox
    Dim bordersblue(7) As PictureBox
    Dim bordersgreen(5) As PictureBox
    ...
    Private Sub Level4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        bordersred = New PictureBox() {picwallred1, picwallred3, picwallred2, picwallred4, picwallred5, picwallyellow2, picwallyellow4, picwallred8, picwallred7, picwallyellow1, picwallred6, picwallred10, picwallred11, picwallyellow5, picwallred9, picwallyellow3}
        bordersblue = New PictureBox() {picwallblue1, picwallblue2, picwallblue3, picwallblue4, picwallblue5, picwallblue6, picwallblue7, picwallblue8}
        bordersgreen = New PictureBox() {picwallblue1, picwallgreen2, picwallgreen3, picwallgreen4, picwallgreen5, picwallgreen6}
    ...
    Private Sub Level4_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If picCharacter1.Bounds.IntersectsWith(picCheckPoint1.Bounds) Then
            x = 300
            y = 350
        End If
        If picCharacter1.Bounds.IntersectsWith(picCheckPoint2.Bounds) Then
            ...
            y = 560
        End If
        If picCharacter1.Bounds.IntersectsWith(picCheckPoint3.Bounds) Then
            x = 125
            y = 800
        End If
        If picCharacter1.Location.X >= 975 Then
            Level4Complete.Show()
            Me.Close()
        End If
    ...
    Private Sub Level4_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
        If e.KeyCode = Keys.Up Then
            upY = False
        End If
        If e.KeyCode = Keys.Down Then
        ...
        For Me.numboxred = 0 To 10
            If picCharacter1.Bounds.IntersectsWith(bordersred(numboxred).Bounds) Then
                ...
                If TimerRed2.Enabled = True And picflashred = 1 Then
                    ...
                    picwallred10.Visible = True
                    picwallred11.Visible = True
                    Delay(1.1)
                    ...
                    picwallred10.Visible = False
                    picwallred11.Visible = False
                End If
            End If
        Next
