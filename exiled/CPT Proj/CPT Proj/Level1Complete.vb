Public Class Level1Complete
    Dim key, upY, downY As Boolean
    Dim valY, msgflash As Double
    Private Sub Level1Complete_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        valY = 2
        upY = True
        downY = True
        key = True
    ...
    Private Sub Level1Complete_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If key = True Then
            If upY = True Then
    ...
    Private Sub Level1Complete_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
